...
<th>Played on<br> Live <span class="live-icon"></span></th>
    ...
    $(function () {
        $.getJSON(
            ...
            function (json) {
                ...
                var awaystats = json.away_team_statistics
                function check() {
                    if (status == "in_progress") { return ' Live <span class="live-icon"></span>' } else { return }
                }
...
<td>${awaystats.corners}</td>
                    ...
                    main.prepend(appelm);
                    setInterval(update(appelm), 1000);
                } else {
                    var appelm = document.createElement("div");
