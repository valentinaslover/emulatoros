...
function interval(app, play, json) {
  ...
  for(app in events) {
    ...
    eventelm.innerHTML = `<div style="text-align:${events[app].country === home ? 'left' : 'right'};">
    <span style="color:${eventToColour(events[app].type_of_event)}">${mapEventType(events[app].type_of_event)}</span>
